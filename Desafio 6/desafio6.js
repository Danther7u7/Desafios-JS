...
function getCantidadTotal(){
    cantidadTotal > 0 ? alert(`La cantidad de productos es de: ${cantidadTotal}`) : alert("Todavia no se registran productos")
}

function getPrecioTotal(){
    precioTotal > 0 && alert(`El valor total de productos es de: ${precioTotal}`)
}
