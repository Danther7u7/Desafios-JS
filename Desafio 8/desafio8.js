    ...
    fetch('data.json')
        ...
        .then(function(data){
            ...
            data.forEach(function(producto){
                Swal.fire(`El producto mas vendido fue: ${producto.nombre}`)
            })
        })
...
let boton3 = document.getElementById("btnPopular");
boton3.addEventListener("click", getProductos)

let boton4 = document.getElementById("registrar");
boton4.addEventListener("click", registro)
